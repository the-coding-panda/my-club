...
{
    public abstract class MyClubWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyClubWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyClubWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyClubDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyClubDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyClubDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyClubDbContext, Task<T>> func)
        {
            T result;
